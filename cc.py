...
def logo():
    figlet = Figlet(font="standard").renderText("Red CC")
    return (rd + figlet)
print (logo())
print (gn + "[-] Powered by Alienrazor ")
print (gn + "[+] Made By Alienrazor")
print (gn + "[=] Red CC Tools Version : 1.1")
...
def genscard():
    ...
    return (gn + "[-] Brand : %s\n[-] Card Number : %s\n[-] Bank : %s\n[-] Name : %s\n[-] Address : %s\n[-] Country : %s\n[-] Money Range : %s\n[-] CVV : %s\n[-] Expiry : %s\n[-] Pin : %s\n============================\n[*]   Generated By Red CC" % (card['IssuingNetwork'] , card['CardNumber'] , card['Bank'] , card['Name'] , card['Address'] , card['Country'] , card['MoneyRange'] , card['CVV'] , card['Expiry'] , card['Pin']) + cv)
